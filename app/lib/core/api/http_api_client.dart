...
class HttpApiClient implements ApiClient {
  ...
  @override
  Future<List<String>> simScenarios() async =>
      ((await _dio.get('/sim/scenarios')).data as List).cast<String>();

  @override
  Future<void> triggerScenario(String sessionId, String event) async {
    await _dio
