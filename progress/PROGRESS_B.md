...
- **B2 live on seeded data: E2–E7, E9.** Stubs remain for sessions/checklist/briefing (B7), W1 + sim (B8), alerts (B9), assistant (B11), voice (B12), training (B13). Notes for your `HttpApiClient`:
